...
class ArticleImg_Plugin implements Typecho_Plugin_Interface
{
 ...
 // 	  $html = '
	//     <section class="typecho-post-option">
	// 	<label for="thumbnail-url" class="typecho-label">文章顶部图片URL</label>
	// 	<p><input id="thumbnail-url" name="thumbnail-url" type="text" value="unknown" class="w-100 text" /></p>
	//   </section>
	//   ';
	//   _e($html); }
	// }
	...
	{
	  $defaultUrl = new Typecho_Widget_Helper_Form_Element_Text('defaultUrl', NULL, _t('http://cfskr.img48.wal8.com/img48/557301_20160918094046/147565611504.jpg'), _t('默认文章图片URL'), _t('在这里输入默认的图片URL'));
	...
	// }
	// 	else{
	// 		$value['thumb'] = 'http://cfskr.img48.wal8.com/img48/557301_20160918094046/147565611504.jpg';}
		return $value;
	// }
	}
	/**
